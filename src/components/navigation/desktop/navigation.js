...
import '../../../images/logo'
import { quapni_logo_white, quapni_logo } from '../../../images/logo';
                        ...
                        <div className="header-content">
                            ...
                            <div className="header-navigation">
                                ...
                                <ul className="nav-basic">
                                    ...
                                    <li>
                                        <a className="browse-item-basic" href="">商品總覽</a>
                                    </li>
                                    <li className="mega-dropdown" style={{ textAlign: 'left' }}>
                                        <a className="browse-item-basic" href="#" style={{ paddingTop: 16, paddingBottom: 20 }}>
                                            商品分類
                                                </a>
                                        <div className="megamenu widget center">
                                            <div className="blur-basic" />
                            ...
                            <div style={{ marginRight: 30 }}>
                                <ul className="nav-basic right-basic">
                                    <li>
                                        <a className="browse-item-basic" href="#">登入&nbsp;｜&nbsp;註冊</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div style={{ marginRight: 30 }}>
                                <ul className="nav-basic right-basic">
                                    <li>
                                        <a className="browse-item-basic mouse-pointer">
